...
from vex.utils import ConfigParser
from vex.faiss import FaissIndex, IndexStatus, UpdateResult

from config import VEX, EMBEDDINGS
...
class State:
    def __init__(self) -> None:
        ...
        self.database_engine = DatabaseEngine(EMBEDDINGS)
        self.index = NoIndex()
        pass
...
async def lifespan(app: FastAPI):
    _config_parser = ConfigParser(VEX)
